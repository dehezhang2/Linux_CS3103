...
path = ['../data/original/shanghaitech/part_A_final/test_data/images/'];
gt_path_csv = ['../data/original/shanghaitech/part_A_final/test_data/ground-truth_csv/'];
...
for i = 1:num_images    
    ...
    load(strcat('GT_IMG_',num2str(i),'.mat'));
